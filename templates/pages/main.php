...
<section class="board-filter">
    <div class="container">
        <div class="menu-filter border rounded my-5 mx-sm-n4 py-5 px-2 px-sm-5 text-center">
